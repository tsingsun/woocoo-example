...
require (
	...
	github.com/tsingsun/woocoo/contrib/gql v0.0.0-20230224063419-6d0ba02ebe28
	github.com/tsingsun/woocoo/contrib/telemetry v0.1.2-0.20230224063419-6d0ba02ebe28
